...
bash_filename_template='bash/{model_name}_X{bond_dim}_{batch_name}.sh'
...
python run_calculate_observables.py --input_filename {folder_name}/tensor.pt --output_filename {folder_name}/observables.csv --observables magnetizationX magnetizationY magnetizationZ --double_layer --device $device
