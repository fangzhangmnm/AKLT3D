...
class AKLTModel(TNModel):
    def get_observable_moments(self,name,n):
        shorthand={'SX':'magnetizationX','SY':'magnetizationY','SZ':'magnetizationZ'}
        name=shorthand[name.upper()] if name.upper() in shorthand else name
